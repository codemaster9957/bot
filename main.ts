...
sprites.onCreated(SpriteKind.Enemy, function (sprite) {
    ...
    statusbar2.attachToSprite(sprite)
    statusbar2.setBarBorder(1, 15)
    if (sprite.overlapsWith(null)) {
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    tiles.createSpritesOnTiles(sprites.dungeon.stairEast, SpriteKind.bot)
})
controller.combos.attachCombo("B+R", function () {
    controller.moveSprite(mySprite)
    scene.cameraFollowSprite(mySprite)
})
sprites.onCreated(SpriteKind.bot, function (sprite) {
    sprite.setImage(img`
        . . . . . . f f f f . . . . . . 
        . . . . f f f 2 2 f f f . . . . 
        . . . f f f 2 2 2 2 f f f . . . 
...
game.onUpdateInterval(5000, function () {
    tiles.createSpritesOnTiles(sprites.dungeon.collectibleInsignia, SpriteKind.Enemy)
})
